...
if exist( 'HCTSANorm.mat', 'file')
    delete( 'HCTSANorm.mat' )
end
...
save('INP_testNorm.mat','timeSeriesData','labels','keywords');

% Initialize a new hctsa analysis using these data and the default feature library:
TS_init('INP_testNorm.mat', 'INP_mops.txt', 'INP_ops.txt', false, 'HCTSANorm.mat');

%% Option 1: Focusing on what we need
out = NL_TISEAN_d2( vFrame', 1, 10, 0, 'c2tdat_Norm.mat' );
% out = NL_TISEAN_d2( vFrame', 14, 10, 20 )
save( 'HCTSANorm.mat', 'out' )
...
% TS_compute(false,[],[],'missing','HCTSANorm.mat',true)