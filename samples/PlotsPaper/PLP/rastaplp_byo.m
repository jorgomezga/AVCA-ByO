function [cepstra] = rastaplp_byo(samples, sr, dorasta, modelorder, iFrame, iSolape, sTipo)
%Eliminado: , spectra, pspectrum, lpcas, F, M
...
pspectrum = powspec_byo(samples, sr, wintime, steptime,sTipo);
