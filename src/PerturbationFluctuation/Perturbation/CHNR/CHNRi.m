...
%     title('O(f) vs Nap(f)');
%     legend( {'Speech Spectrum', 'Nap'} )
%     
%     figure(2); plot(eje_f,log10(exp(log_espec)),'b',eje_f,log10(exp(Haap)),'g');
%     title('log speech spectrum vs Haap (dB)');
%     legend( {'Speech Spectrum', 'Haap'} )
%     
%     figure(3); plot(eje_f,log10(exp(log_espec)),'r',eje_f,log10(exp(Bd)),'g');
%     legend( {'Speech Spectrum', 'Bd'} )
%     title('log speech spectrum vs Bd (dB)');
%     
%     figure(4); 
    plot(eje_f,log10(exp(log_espec)),'r',eje_f,log10(exp(NoiseSpectrum)),'g');
